...
tkn pipeline start \
  ...
  --param git-ops-repo-url=git@github.com:${GIT_ORG}/cluster-gitops.git \
  --param gitops-apps-repo-full-name=${GIT_ORG}/cluster-gitops \
  ...
  --workspace name=gitops-repo-secret,secret=cluster-gitops-at-github
